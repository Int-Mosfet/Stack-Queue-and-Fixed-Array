...
public:
	...
	*/
	...
	/// Resize and Shrink methods are now private to Array class
	/// Fixed array can't access now


	/// Want derived classes to be able to inherit this data
	/// So use "protected" specifier
protected:
