 ...
 */
template <typename T>
class Array : public Base_Array <T> /*Inherits from Base_Array class*/
{
public:
   ...
   *
   * @return		The data in data pointer
   */
   T data(void) const;
  ...
  //using Base_Array<T>::get; //<--I believe this works, implement after comments
  ...
  /// Don't need any variables, can get access
  /// to all of them through inline files
private:
